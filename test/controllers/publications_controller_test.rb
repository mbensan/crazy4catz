...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference("Publication.count") do
      post publications_url, params: { publication: { body: @publication.body, title: @publication.title, user_id: @publication.user_id } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { body: @publication.body, title: @publication.title, user_id: @publication.user_id } }
